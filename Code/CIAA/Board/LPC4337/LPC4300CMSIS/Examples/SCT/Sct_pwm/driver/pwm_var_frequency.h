...
*//**
* @file		pwm_var_frequency.h
* @brief	structure definition for the SCT PWM variable frequency
* 			configuration mode
* @version	1.0
* @date		19. June. 2012
...
* this code.
**********************************************************************/
#ifndef __SCT_PWM_VAR_FREQUENCY_H__
#define __SCT_PWM_VAR_FREQUENCY_H__

/******************************************************************************
 * Simple PWM with variable frequency output 
...
extern PWM_STATUS makePwmVarFrequencyConfig(PWM_VarFrequency* config);
