/**********************************************************************
* $Id$		Gpdma_LinkList.c		2011-06-02
*//**
* @file		Gpdma_LinkList.c
...
/* Example group ----------------------------------------------------------- */
/** @defgroup Gpdma_LinkList	Gpdma_LinkList
...
#else
uint32_t DMASrc_Buffer1[DMA_SIZE/2] __attribute__((at(0x20000000))) =
#endif
{
...
#else
uint32_t DMASrc_Buffer2[DMA_SIZE/2] __attribute__((at(0x20000200)))=
#endif
{
