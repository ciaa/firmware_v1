...
void hitex_externalMemoryInit(void) __attribute__ ((section("IRAM_INIT_CODE")));
void hitex_externalSpifiInit(void) 	__attribute__ ((section("IRAM_INIT_CODE")));
void hitex_clockInit(void) 			__attribute__ ((section("IRAM_INIT_CODE")));
void hitex_ioInit(void) 			__attribute__ ((section("IRAM_INIT_CODE")));
