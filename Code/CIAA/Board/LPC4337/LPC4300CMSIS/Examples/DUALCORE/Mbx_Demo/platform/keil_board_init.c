/**********************************************************************
* $Id$		keil_board_init.c			2012-03-16
*//**
* @file		keil_board_init.c
* @brief	Keil board specific initialization 
* @version	1.0
...
void keil_emcPinMuxInit(void) {

	/* configure pin multiplexing for external memory */
	/* Nor Flash on Keil board is 32-bit mode */
...
/* Keil board S29GL064N90TFI020 Flash */
...
void keil_externalMemoryInit(void) {
...
void keil_externalSpifiInit(void) {
