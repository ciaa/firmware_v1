...
void hitex_norFlashInit(void) __attribute__ ((section("IRAM_INIT_CODE")));
void hitex_emcPinMuxInit(void) __attribute__ ((section("IRAM_INIT_CODE")));
void emc_WaitUS(volatile uint32_t us) __attribute__ ((section("IRAM_INIT_CODE")));
