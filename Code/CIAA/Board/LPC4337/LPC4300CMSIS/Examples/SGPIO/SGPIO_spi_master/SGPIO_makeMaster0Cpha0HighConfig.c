...
void SGPIO_makeMaster0Cpha0HighConfig(SpiParam const *config) {
	...
	**********************************************************************/
	...
	SGPIO_spiIoctl(CLOCK_CFG0.sliceId, WR_DATA, (void*)0x55555555); 			
...
// 		MC_CONCAT_ORDER_DONTCARE);
	...
	SGPIO_spiIoctl(DATA_OUT_CFG0.sliceId, WR_BIT_COUNT, (void*)config->wordLenght);
	SGPIO_spiIoctl(DATA_OUT_CFG0.sliceId, WR_COUNT_RELOAD, (void*)(SGPIO_IP_CLOCK/((config->bitRateHz))));
	SGPIO_spiIoctl(DATA_OUT_CFG0.sliceId, WR_DATA, 0x0);
	SGPIO_spiIoctl(DATA_OUT_CFG0.sliceId, WR_DATASS, 0x0);
	...
	**********************************************************************/
	...
	LPC_SGPIO->SET_EN_3 = (1<<DATA_IN_CFG0.sliceId);		
