...
/*****************************************************************************
 *
 *  Pin access for the SGPIO - I2S channels on the Hitex rev A4 board:
 ...
 *                         SV6-7  --> SV9-5    Data #1
 *
 *  Jumpers:      SV9 1-2 17-18 19-20, JP13 1-2
 *  No jumpers:   SV8
 *
 *****************************************************************************/
...
int main (void) 
{                   
    // TODO: the vector table address should be set before reaching main(). 
    //       The complete system initialization (clocks, memory etc) should run 
