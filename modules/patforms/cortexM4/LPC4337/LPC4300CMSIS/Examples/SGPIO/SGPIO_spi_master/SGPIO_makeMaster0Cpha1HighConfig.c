...
void SGPIO_makeMaster0Cpha1HighConfig(SpiParam const *config) {
...
// 			
// 	SGPIO_spiIoctl(DATA_DELAY_CPHA1_CFG0.sliceId, WR_BIT_COUNT, (void*)0x4);
// 	// go half as slow as the clock
